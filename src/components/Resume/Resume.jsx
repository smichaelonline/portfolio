function Resume() {
  return (
    <div id="resume">
      ...
      <div>
        <h2>General Assembly - Software Engineering Immersive Fellow</h2>
        <h4>Remote</h4>
        <h4>August 2022 to November 2022</h4>
        ...
        <ul>
          <li>Safe Space: Built with Javascript, HTML, CSS,, MongoDB, Express, Node.js, Adobe Illustrator </li>
          <li>My Lil’ Goblin: Built with Javascript, CSS, HTML </li>
        </ul>
      </div>

      <div>
        <h2>MC Saatchi - Senior Account Executive</h2>
        <h4>New York, NY </h4>
        <h4>April 2022 to August 2022 </h4>
        <ul>
      ...
      <div> 
        <h2>DeVries Global - Account Executive</h2>
        <h4>New York, NY </h4>
        <h4>September 2021 to April 2022 </h4>
        <ul>
          <li>
      ...
      <div> 
        <h2>Taylor Strategy - Assistant Account Executive</h2>
        <h4>New York, NY </h4>
        <h4>September 2019 to September 2021 </h4>
        <ul>
          <li>
      ...
      <h1>Education</h1>
        <ul>
          <li>General Assembly | Software Engineering Immersive | Remote</li> 
          <li>BA in Public Relations | Montclair State University | Graduation Date: 2019</li> 
        </ul>
